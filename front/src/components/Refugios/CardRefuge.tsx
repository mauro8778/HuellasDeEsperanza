...
const CardRefuge: React.FC<{ refugio: IRefugios }> = ({ refugio }) => {
  ...
  return (
    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-4 p-5">
