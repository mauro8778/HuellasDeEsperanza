          ...
          <div className="bg-white rounded-lg p-4 max-w-sm w-full">
            ...
            <div className="mb-4">
              ...
              <select
                ...
                <button className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700" onClick={handleSaveChanges}>Guardar Cambios</button>
                <button className="bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600" onClick={handleModalClose}>Cancelar</button>
                </div>
                </div>
                </div>
                )}
